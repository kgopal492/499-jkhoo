...
grpc::Status KeyValueStoreServiceImpl::put(grpc::ServerContext* context,
...
grpc::Status KeyValueStoreServiceImpl::get(
...
grpc::Status KeyValueStoreServiceImpl::deletekey(
    grpc::ServerContext* context, const chirp::DeleteRequest* request,
