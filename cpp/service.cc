...
void ServiceLayer::registeruser(std::string username) {
...
chirp::Chirp ServiceLayer::chirp(std::string username, std::string text, std::string parent_id) {
...
void ServiceLayer::follow(std::string username, std::string to_follow) {
...
chirp::Chirp ServiceLayer::read(std::string chirp_id) {
...
chirp::Chirp ServiceLayer::monitor(std::string username) {
